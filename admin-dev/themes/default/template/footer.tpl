...
<div id="footer" class="bootstrap hide">
	...
	<div class="col-sm-2 hidden-xs">
		...
		-
		<span id="footer-load-time"><i class="icon-time" title="{l s='Load time test new wording tpl:' d='Admin.Navigation.Footer'}"></i> {number_format(microtime(true) - $timer_start, 3, '.', '')}s</span>
	</div>
